...
export declare class DxTreeViewComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSource: DataSource | DataSourceOptions | Store | string | Array<DevExpress.ui.dxTreeViewItem>;
    /**
     ...
     */
    dataSourceChange: EventEmitter<DataSource | DataSourceOptions | Store | string | Array<DevExpress.ui.dxTreeViewItem>>;
    /**
