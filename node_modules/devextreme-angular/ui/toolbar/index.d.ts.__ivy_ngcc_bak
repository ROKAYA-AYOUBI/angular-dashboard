...
export declare class DxToolbarComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSource: DataSource | DataSourceOptions | Store | string | Array<string | DevExpress.ui.dxToolbarItem | any>;
    /**
     ...
     */
    dataSourceChange: EventEmitter<DataSource | DataSourceOptions | Store | string | Array<string | DevExpress.ui.dxToolbarItem | any>>;
    /**
