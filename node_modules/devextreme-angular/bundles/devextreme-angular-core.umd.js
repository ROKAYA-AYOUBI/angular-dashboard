(function (global, factory) {
    ...
    (global = global || self, factory((global['devextreme-angular'] = global['devextreme-angular'] || {}, global['devextreme-angular'].core = {}), global.ng.core, global.ng.common, global.ng.platformBrowser, global.common$1, global.domAdapter, global.events, global.render, global.ng.common.http, global.httpRequest, global.readyCallbacks, global.eventsEngine, global.ajax, global.deferred));
}(this, (function (exports, core, common, platformBrowser, common$1, domAdapter, events, render, http, httpRequest, readyCallbacks, eventsEngine, ajax, deferred) { 'use strict';

    domAdapter = domAdapter && Object.prototype.hasOwnProperty.call(domAdapter, 'default') ? domAdapter['default'] : domAdapter;
    render = render && Object.prototype.hasOwnProperty.call(render, 'default') ? render['default'] : render;
    httpRequest = httpRequest && Object.prototype.hasOwnProperty.call(httpRequest, 'default') ? httpRequest['default'] : httpRequest;
    readyCallbacks = readyCallbacks && Object.prototype.hasOwnProperty.call(readyCallbacks, 'default') ? readyCallbacks['default'] : readyCallbacks;
    eventsEngine = eventsEngine && Object.prototype.hasOwnProperty.call(eventsEngine, 'default') ? eventsEngine['default'] : eventsEngine;
    ajax = ajax && Object.prototype.hasOwnProperty.call(ajax, 'default') ? ajax['default'] : ajax;
